...
import VenueBookingsPage from '../pages/owner/bookings/VenueBookingsPage';
...
import OwnerRegistrationsPage from '../pages/admin/applications/OwnerRegistrationsPage';
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="/organiser" element={<PortalLayout role="organiser" />}>
            ...
            <Route path="tournaments/:tournamentId/result" element={<UpdateTournamentResultPage />} />
          </Route>
          <Route path="/owner" element={<PortalLayout role="owner" />}>
            ...
            <Route path="venues/:venueId/bookings" element={<VenueBookingsPage />} />
          ...
          <Route path="/admin" element={<PortalLayout role="admin" />}>
            ...
            <Route path="owner-registrations" element={<OwnerRegistrationsPage />} />
